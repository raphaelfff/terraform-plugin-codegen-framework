...
You install a copy of the binary manually from the [releases](https://github.com/raphaelfff/terraform-plugin-codegen-framework/releases) tab, or install via the Go toolchain:

```shell
go install github.com/raphaelfff/terraform-plugin-codegen-framework/cmd/tfplugingen-framework@latest
```
